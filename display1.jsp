...
<%
    ...
    %>
    <a href="insert-question.html"><button class="btn success" style="float: left;">Back</button></a>
    <%
	while(rs.next()){
%>
<div class="test">
...
<input type="text" name="value" placeholder="Question no">
